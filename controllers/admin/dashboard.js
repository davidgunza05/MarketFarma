...
exports.chartData = async (req, res) => {
  try {
    ...
    res.json({
      data: { orderData, inTransit, Cancelado, delivered },
    });
  } catch (error) {
...
exports.OrderData = async (req, res) => {
  try {
    ...
    const delivered = deliveredOrderes;
    res.render('admin/relatorios/total', { orderData, inTransit, Cancelado, delivered, dailyOrderData, documentTitle: 'Relatórios de venda',});
...
exports.Status = async (req, res) => {
  try {
    ...
    const delivered = deliveredOrderes;
    res.render('admin/relatorios/status', { orderData, inTransit, Cancelado, delivered, dailyOrderData, documentTitle: 'Relatórios de venda',});
